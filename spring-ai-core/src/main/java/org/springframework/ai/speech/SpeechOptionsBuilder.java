...
public class SpeechOptionsBuilder {
	...
	private class SpeechOptionsImpl implements SpeechOptions {
	...
	private final SpeechOptionsImpl options = new SpeechOptionsImpl();
	...
	public SpeechOptionsBuilder withInput(String input) {
