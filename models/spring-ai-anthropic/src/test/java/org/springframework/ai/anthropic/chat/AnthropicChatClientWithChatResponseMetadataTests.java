 ...
 * @since 0.7.0
 */
@RestClientTest(AnthropicChatClientWithChatResponseMetadataTests.Config.class)
public class AnthropicChatClientWithChatResponseMetadataTests {
	...
	static class Config {
		...
		@Bean
		public AnthropicApi chatCompletionApi(RestClient.Builder builder) {
			return new AnthropicApi("", TEST_API_KEY, builder);
		}
