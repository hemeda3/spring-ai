...
import org.springframework.ai.anthropic.metadata.support.AnthropicResponseHeaderExtractor.DurationFormatter;

/**
 * Unit Tests for {@link AnthropicHttpResponseHeadersInterceptor}.
 *
 * @author John Blum
 * @author Christian Tzolov
 * @since 0.7.0
 */
public class AnthropicResponseHeaderExtractorTests {
