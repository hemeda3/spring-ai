...
class AnthropicChatClientIT extends AbstractIT {
	...
	void outputParser() {
		...
		Generation generation = this.AnthropicChatClient.call(prompt).getResult();
	...
	void mapOutputParser() {
		...
		Prompt prompt = new Prompt(promptTemplate.createMessage());
		Generation generation = AnthropicChatClient.call(prompt).getResult();
	...
	void functionCallTest() {
		...
		var promptOptions = AnthropicChatOptions.builder()
			.withModel(AnthropicApi.ChatModel.GPT_4_TURBO_PREVIEW.getValue())
		...
		ChatResponse response = AnthropicChatClient.call(new Prompt(messages, promptOptions));
