...
/**
 * Based on the Anthropic Function Calling tutorial:
 * https://platform.Anthropic.com/docs/guides/function-calling/parallel-function-calling
 *
 * @author Christian Tzolov
 */
@EnabledIfEnvironmentVariable(named = "Anthropic_API_KEY", matches = ".+")
public class AnthropicApiToolFunctionCallIT {

	private final Logger logger = LoggerFactory.getLogger(AnthropicApiToolFunctionCallIT.class);

	MockWeatherService weatherService = new MockWeatherService();

	AnthropicApi completionApi = new AnthropicApi(System.getenv("Anthropic_API_KEY"));
	...
	public void toolFunctionCall() {
		...
		var functionTool = new AnthropicApi.FunctionTool(Type.FUNCTION,
				new AnthropicApi.FunctionTool.Function(
		...
		// var functionTool = new AnthropicApi.FunctionTool(Type.FUNCTION, new
		// AnthropicApi.FunctionTool.Function(
