 ...
 */
package org.springframework.ai.anthropic.transformer;
...
public class MetadataTransformerIT {
	...
	public static class AnthropicTestConfiguration {

		@Bean
		public AnthropicApi AnthropicApi() throws IOException {
		...
		@Bean
		public AnthropicChatClient AnthropicChatClient(AnthropicApi anthropicApi) {
			AnthropicChatClient anthropicChatClient = new AnthropicChatClient(anthropicApi);
			return anthropicChatClient;
		}

		@Bean
		public KeywordMetadataEnricher keywordMetadata(AnthropicChatClient aiClient) {
			return new KeywordMetadataEnricher(aiClient, 5);
		}

		@Bean
		public SummaryMetadataEnricher summaryMetadata(AnthropicChatClient aiClient) {
