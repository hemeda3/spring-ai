...
/**
 * OpenAI Image API options. AnthropicImageOptions.java
 *
 * @author Mark Pollack
...
public class AnthropicImageOptions implements ImageOptions {
	 ...
	 */
	@JsonProperty("model")
	private String model = AnthropicImageApi.DEFAULT_IMAGE_MODEL;
	...
	public static class Builder {
		...
		private final AnthropicImageOptions options;

		private Builder() {
			this.options = new AnthropicImageOptions();
		}
		...
		public AnthropicImageOptions build() {
			return options;
		}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof AnthropicImageOptions that))
			return false;
	...
	public String toString() {
		return "AnthropicImageOptions{" + "n=" + n + ", model='" + model + '\'' + ", width=" + width + ", height=" + height
