...
import org.springframework.ai.anthropic.api.AnthropicApi.FunctionTool;
...
public class AnthropicChatOptions implements FunctionCallingOptions, ChatOptions {
	...
	public static class Builder {
		...
		protected AnthropicChatOptions options;

		public Builder() {
			this.options = new AnthropicChatOptions();
		}

		public Builder(AnthropicChatOptions options) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AnthropicChatOptions other = (AnthropicChatOptions) obj;
		if (this.model == null) {
			if (other.model != null)
				return false;
		}
