...
public class AnthropicEmbeddingOptions implements EmbeddingOptions {
	...
	public static class Builder {
		...
		protected AnthropicEmbeddingOptions options;

		public Builder() {
			this.options = new AnthropicEmbeddingOptions();
		}
		...
		public AnthropicEmbeddingOptions build() {
			return this.options;
		}
