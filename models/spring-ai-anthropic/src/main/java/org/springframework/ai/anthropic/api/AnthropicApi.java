...
// @formatter:off
/**
 * Single class implementation of the Anthropic Chat Completion API: https://platform.anthropic.com/docs/api-reference/chat and
 * Anthropic Embedding API: https://platform.anthropic.com/docs/api-reference/embeddings.
 *
...
public class AnthropicApi {
	...
	/**
	 * Create an new chat completion api with base URL set to https://api.anthropic.com
	 *
	 * @param AnthropicToken Anthropic apiKey.
	 */
	public AnthropicApi(String AnthropicToken) {
		this(ApiUtils.DEFAULT_BASE_URL, AnthropicToken);
	}
	 ...
	 * @param AnthropicToken Anthropic apiKey.
	 */
	public AnthropicApi(String baseUrl, String AnthropicToken) {
		this(baseUrl, AnthropicToken, RestClient.builder());
	}
	 ...
	 */
	public AnthropicApi(String baseUrl, String AnthropicToken, RestClient.Builder restClientBuilder) {
		this(baseUrl, AnthropicToken, restClientBuilder, RetryUtils.DEFAULT_RESPONSE_ERROR_HANDLER);
	}
	 ...
	 */
	public AnthropicApi(String baseUrl, String AnthropicToken, RestClient.Builder restClientBuilder, ResponseErrorHandler responseErrorHandler) {

		this.restClient = restClientBuilder
				.baseUrl(baseUrl)
				.defaultHeaders(ApiUtils.getJsonContentHeaders(AnthropicToken))
	 ...
	 * <a href="https://platform.anthropic.com/docs/models/gpt-4-and-gpt-4-turbo">GPT-4 and GPT-4 Turbo</a> and
	 * <a href="https://platform.anthropic.com/docs/models/gpt-3-5-turbo">GPT-3.5 Turbo</a>.
	 */
...
/**
	 ...
	 * @param user A unique identifier representing your end-user, which can help Anthropic to monitor and detect abuse.
	 *
	 */
	@JsonInclude(Include.NON_NULL)
	...
	private AnthropicStreamFunctionCallingHelper chunkMerger = new AnthropicStreamFunctionCallingHelper();
	...
	/**
	 * Anthropic Embeddings Models:
	 * <a href="https://platform.anthropic.com/docs/models/embeddings">Embeddings</a>.
	 */
