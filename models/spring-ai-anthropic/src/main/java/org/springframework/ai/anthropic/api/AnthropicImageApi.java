 ...
 */
public class AnthropicImageApi {
	 ...
	 */
	public AnthropicImageApi(String openAiToken) {
	 ...
	 */
	public AnthropicImageApi(String baseUrl, String openAiToken, RestClient.Builder restClientBuilder) {
