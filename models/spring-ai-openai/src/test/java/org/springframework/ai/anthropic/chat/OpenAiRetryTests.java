...
import org.springframework.ai.anthropic.OpenAiAudioTranscriptionClient;
import org.springframework.ai.anthropic.OpenAiAudioTranscriptionOptions;
import org.springframework.ai.anthropic.OpenAiChatClient;
import org.springframework.ai.anthropic.OpenAiChatOptions;
import org.springframework.ai.anthropic.OpenAiEmbeddingClient;
import org.springframework.ai.anthropic.OpenAiEmbeddingOptions;
import org.springframework.ai.anthropic.OpenAiImageClient;
import org.springframework.ai.anthropic.OpenAiImageOptions;
import org.springframework.ai.anthropic.api.OpenAiApi;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletion;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletionChunk;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletionFinishReason;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletionMessage;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletionMessage.Role;
import org.springframework.ai.anthropic.api.OpenAiApi.ChatCompletionRequest;
import org.springframework.ai.anthropic.api.OpenAiApi.Embedding;
import org.springframework.ai.anthropic.api.OpenAiApi.EmbeddingList;
import org.springframework.ai.anthropic.api.OpenAiApi.EmbeddingRequest;
import org.springframework.ai.anthropic.api.OpenAiAudioApi;
import org.springframework.ai.anthropic.api.OpenAiAudioApi.StructuredResponse;
import org.springframework.ai.anthropic.api.OpenAiAudioApi.TranscriptResponseFormat;
import org.springframework.ai.anthropic.api.OpenAiAudioApi.TranscriptionRequest;
import org.springframework.ai.anthropic.api.OpenAiImageApi;
import org.springframework.ai.anthropic.api.OpenAiImageApi.Data;
import org.springframework.ai.anthropic.api.OpenAiImageApi.OpenAiImageRequest;
import org.springframework.ai.anthropic.api.OpenAiImageApi.OpenAiImageResponse;
