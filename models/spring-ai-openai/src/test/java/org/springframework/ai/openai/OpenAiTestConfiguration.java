...
public class OpenAiTestConfiguration {
	...
	@Bean
	public OpenAiSpeechApi openAiSpeechApi() {
		return new OpenAiSpeechApi(getApiKey());
	}
	...
	public OpenAiSpeechClient openAiSpeechClient(OpenAiSpeechApi openAiSpeechApi) {
		OpenAiSpeechClient openAiSpeechClient = new OpenAiSpeechClient(openAiSpeechApi);
