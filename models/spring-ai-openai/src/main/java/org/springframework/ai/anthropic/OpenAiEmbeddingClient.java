...
import org.springframework.ai.anthropic.api.OpenAiApi.Usage;
...
public class OpenAiEmbeddingClient extends AbstractEmbeddingClient {
	...
	public EmbeddingResponse call(EmbeddingRequest request) {
		...
		return this.retryTemplate.execute(ctx -> {
			...
			org.springframework.ai.anthropic.api.OpenAiApi.EmbeddingRequest<List<String>> apiRequest = (this.defaultOptions != null)
					? new org.springframework.ai.anthropic.api.OpenAiApi.EmbeddingRequest<>(request.getInstructions(),
			...
			if (request.getOptions() != null && !EmbeddingOptions.EMPTY.equals(request.getOptions())) {
				apiRequest = ModelOptionsUtils.merge(request.getOptions(), apiRequest,
						org.springframework.ai.anthropic.api.OpenAiApi.EmbeddingRequest.class);
			}
