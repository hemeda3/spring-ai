...
public class OpenAiAudioSpeechClient implements SpeechClient, StreamingSpeechClient {
	...
	public byte[] call(String text) {
		AudioSpeechPrompt speechRequest = new AudioSpeechPrompt(text);
		return call(speechRequest).getResult().getOutput();
	}

	@Override
	public SpeechResponse call(AudioSpeechPrompt speechPrompt) {
	...
	@Override
	public Flux<SpeechResponse> stream(AudioSpeechPrompt prompt) {
	...
	private OpenAiAudioApi.SpeechRequest createRequestBody(AudioSpeechPrompt request) {
